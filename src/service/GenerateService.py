...
class GenerateService:
    ...
    def generate(
        ...
        assistant = self.client.beta.assistants.create(
            ...
            instructions="You are an AI language model specialized in extracting key information from text. Your task is to identify and present the most relevant details from any given passage. You should focus on facts, figures, dates, names, and other significant pieces of information, while ignoring filler content and irrelevant details. Always provide concise and clear summaries of the extracted information.",
        )
        ...
        thread = self.client.beta.threads.create(
            messages=[
                {
                "role": "user",
                "content": f"{promptText} {key_information}",
                }
            ]
        )
        run = self.client.beta.threads.runs.create_and_poll(
        ...
        assistant = self.client.beta.assistants.update(
            ...
            instructions=f"""
                        ...
                        Your task is to generate detailed descriptions for sections of a business analysis document.
                        
                        We don't need coclusion section for every section, but for every chapter.
                        Below is a basic description of the business for your reference.
                        {key_information}
                        The result should be HTML without body, head tag so that I can add it into existing html.
                        """,
        )        
